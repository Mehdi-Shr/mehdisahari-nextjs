...
export const metadata: Metadata = {
  title: "Mehdi Sahari — Freelance IA & Automatisation | Paris",
  description: "Consultant en automatisation à Paris · Workflows n8n, agents IA et création de SaaS sur mesure. 3 ans d'expérience. Obtenez un audit gratuit →",
  alternates: { canonical: "https://mehdisahari.fr/automatisation-paris" },
  openGraph: {
    title: "Mehdi Sahari — Freelance IA & Automatisation | Paris",
    description: "Automatisation n8n, création de SaaS et sites web qui convertissent. Basé à Montpellier, disponible à Paris.",
    url: "https://mehdisahari.fr/automatisation-paris",
  },
};
...
const serviceSchema = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "Automatisation & IA à Paris",
  provider: { "@type": "Person", name: "Mehdi Sahari", url: "https://mehdisahari.fr" },
  description: "Workflows n8n et agents IA sur mesure pour automatiser les process métiers des entreprises à Paris.",
