...
export const metadata: Metadata = {
  title: "Mehdi Sahari — Freelance IA & Automatisation | Luxembourg",
  description: "Consultant en automatisation en Luxembourg · Workflows n8n, agents IA et création de SaaS sur mesure. 3 ans d'expérience. Obtenez un audit gratuit →",
  alternates: { canonical: "https://mehdisahari.fr/automatisation-luxembourg" },
  openGraph: {
    title: "Mehdi Sahari — Freelance IA & Automatisation | Luxembourg",
    description: "Automatisation n8n, création de SaaS et sites web qui convertissent. Basé à Montpellier, disponible en Luxembourg.",
    url: "https://mehdisahari.fr/automatisation-luxembourg",
  },
};
...
const serviceSchema = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "Automatisation & IA en Luxembourg",
  provider: { "@type": "Person", name: "Mehdi Sahari", url: "https://mehdisahari.fr" },
  description: "Workflows n8n et agents IA sur mesure pour automatiser les process métiers des entreprises en Luxembourg.",
...
export default function Page() {
  return (
    <>
      ...
      <CityPageLayout city="Luxembourg" />
    </>
  );
}
