...
export const metadata: Metadata = {
  title: "Mehdi Sahari — Freelance IA & Automatisation | Namur",
  description: "Consultant en automatisation à Namur · Workflows n8n, agents IA et création de SaaS sur mesure. 3 ans d'expérience. Obtenez un audit gratuit →",
  alternates: { canonical: "https://mehdisahari.fr/automatisation-namur" },
  openGraph: {
    title: "Mehdi Sahari — Freelance IA & Automatisation | Namur",
    description: "Automatisation n8n, création de SaaS et sites web qui convertissent. Basé à Montpellier, disponible à Namur.",
    url: "https://mehdisahari.fr/automatisation-namur",
  },
};
...
const serviceSchema = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "Automatisation & IA à Namur",
  provider: { "@type": "Person", name: "Mehdi Sahari", url: "https://mehdisahari.fr" },
  description: "Workflows n8n et agents IA sur mesure pour automatiser les process métiers des entreprises à Namur.",
  areaServed: { "@type": "City", name: "Namur" },
