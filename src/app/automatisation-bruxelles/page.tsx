...
export const metadata: Metadata = {
  title: "Mehdi Sahari — Freelance IA & Automatisation | Bruxelles",
  description: "Consultant en automatisation à Bruxelles · Workflows n8n, agents IA et création de SaaS sur mesure. 3 ans d'expérience. Obtenez un audit gratuit →",
  alternates: { canonical: "https://mehdisahari.fr/automatisation-bruxelles" },
  openGraph: {
    title: "Mehdi Sahari — Freelance IA & Automatisation | Bruxelles",
    description: "Automatisation n8n, création de SaaS et sites web qui convertissent. Basé à Montpellier, disponible à Bruxelles.",
    url: "https://mehdisahari.fr/automatisation-bruxelles",
  },
};
...
const serviceSchema = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "Automatisation & IA à Bruxelles",
  provider: { "@type": "Person", name: "Mehdi Sahari", url: "https://mehdisahari.fr" },
  description: "Workflows n8n et agents IA sur mesure pour automatiser les process métiers des entreprises à Bruxelles.",
