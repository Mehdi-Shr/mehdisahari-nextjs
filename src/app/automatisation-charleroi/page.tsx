...
export const metadata: Metadata = {
  title: "Mehdi Sahari — Freelance IA & Automatisation | Charleroi",
  description: "Consultant en automatisation à Charleroi · Workflows n8n, agents IA et création de SaaS sur mesure. 3 ans d'expérience. Obtenez un audit gratuit →",
  alternates: { canonical: "https://mehdisahari.fr/automatisation-charleroi" },
  openGraph: {
    title: "Mehdi Sahari — Freelance IA & Automatisation | Charleroi",
    description: "Automatisation n8n, création de SaaS et sites web qui convertissent. Basé à Montpellier, disponible à Charleroi.",
    url: "https://mehdisahari.fr/automatisation-charleroi",
  },
};
...
const serviceSchema = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "Automatisation & IA à Charleroi",
  provider: { "@type": "Person", name: "Mehdi Sahari", url: "https://mehdisahari.fr" },
  description: "Workflows n8n et agents IA sur mesure pour automatiser les process métiers des entreprises à Charleroi.",
  areaServed: { "@type": "City", name: "Charleroi" },
