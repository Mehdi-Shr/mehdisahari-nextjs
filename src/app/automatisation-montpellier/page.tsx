...
export const metadata: Metadata = {
  ...
  description: "Consultant en automatisation à Montpellier · Workflows n8n, agents IA et création de SaaS sur mesure. 3 ans d'expérience. Obtenez un audit gratuit →",
  alternates: { canonical: "https://mehdisahari.fr/automatisation-montpellier" },
  openGraph: {
    title: "Mehdi Sahari — Freelance IA & Automatisation | Montpellier",
    description: "Automatisation n8n, création de SaaS et sites web qui convertissent. Basé à Montpellier, disponible à Montpellier.",
    url: "https://mehdisahari.fr/automatisation-montpellier",
  },
};
...
const serviceSchema = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "Automatisation & IA à Montpellier",
  provider: { "@type": "Person", name: "Mehdi Sahari", url: "https://mehdisahari.fr" },
  description: "Workflows n8n et agents IA sur mesure pour automatiser les process métiers des entreprises à Montpellier.",
...
export default function Page() {
  return (
    <>
      ...
      <CityPageLayout city="Montpellier" />
    </>
  );
}
